...
try:
    ...
    raise ImportError( 'Webpage requires extra dependencies. Install with `pip install --upgrade "embedchain[dataloaders]"`'
                      ) from None
...
class WebPageLoader:
    ...
    def load_data(self, url):
        """ Load data from a webpage. using a shared session."""
